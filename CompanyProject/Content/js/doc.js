/*!
 * ZUI: Document - v1.8.1 - 2018-01-18
 * http://zui.sexy
...
+(function (window, $) {
    ...
    if ($.zui.browser.ie && $.zui.browser.ie < 11) {
        $.zui.messager.danger('ä½ æ­£åœ¨ä½¿ç”¨ IE è¾ƒä½Žç‰ˆæœ¬è®¿é—®ï¼Œæ— æ³•èŽ·å¾— ZUI æ–‡æ¡£ç½‘ç«™çš„å®Œæ•´ä½“éªŒï¼Œå»ºè®®ä½ æ›´æ¢æµè§ˆå™¨å†è®¿é—®ã€‚', { time: 20000 });
    }
    ...
    var queryIcon = function (keys) {
        ...
        if (!$search.length) {
            $search = $('<div class="section-search card-content"><div class="loader loading"><i class="icon icon-spin icon-spinner"></i> æ­£åœ¨æ‹¼å‘½åŠ è½½ä¸­...</div></div>');
    ...
    var openPage = function ($section, section, topic) {
        ...
        if (lib) {
            ...
            if (isShowCodeBadage) {
                ...
                if (lib.bundlesCount) {
                    $dropdown.append('<li class="dropdown-header primary-header" data-type="bundles"><i class="icon icon-cube"></i> æ‰“åŒ…</li>');
                    if (lib.bundles.standard) {
                        $dropdown.append('<li class="dropdown-header">æ ‡å‡†ç‰ˆ</li>');
                        var files = [];
                    ...
                    if (lib.bundles.lite) {
                        $dropdown.append('<li class="dropdown-header">ç®€æ´ç‰ˆ</li>');
                        var files = [];
                        if (lib.src.js && lib.src.js.length) {
    ...
    var openSection = function (section, topic) {
        ...
        if (section.url === '') {
            $.zui.messager.show('è¯¥é“¾æŽ¥æ‰€æŒ‡ç¤ºçš„æ–‡æ¡£å°šæœªå®Œæˆã€‚ä½ å¯ä»¥Forké¡¹ç›®æ¥å®Œå–„æ–‡æ¡£ã€‚');
            return;
        }
        ...
        loadPackage(function (data) {
            ...
            $.each(data.lib, function (itemName, item) {
                ...
                if (item.source) {
                    ...
                    $td.append('<span class="text-muted">(åˆå¹¶ç»„ä»¶)</span>');
                } else {
                    isZUI = true;
    ...
    var initCopyable = function () {
        if (!$.zui.browser.isIE() || $.zui.browser.ie > 8) {
            ...
            clipboard.on('success', function (e) {
                ...
                $copyCodeBtn.tooltip('show', 'å·²å¤åˆ¶ <i class="icon icon-ok"></i>');
                e.clearSelection();
            });

            clipboard.on('error', function (e) {
                $('#copyCodeTip').addClass('tooltip-warning');
                $copyCodeBtn.tooltip('show', isTouchScreen ? 'ä½ çš„æµè§ˆå™¨ä¸æ”¯æŒç›´æŽ¥å¤åˆ¶ï¼Œè¯·è‡ªè¡Œé€‰æ‹©å¹¶å¤åˆ¶ã€‚' : 'æŒ‰ <strong>Ctrl+C</strong> å®Œæˆå¤åˆ¶');
            });
